...
|---|---|---|
| **`barber/`** | `KikeGonRam/barber` (rama `main`) | API JSON pura (Bearer token, `mobile_api_tokens`) — sin ninguna página Blade real desde el 2026-09-09; solo redirects a `frontend-urban` |
