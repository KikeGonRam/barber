    ...
    */
    ...
    'pages' => [
        ...
        'paths' => [
            ...
            // Mayúscula a propósito: coincide con resources/js/Pages, la
            // estructura real de este repo (y con el resolver de
            // resources/js/inertia.js, import.meta.glob('./Pages/**/*.vue')).
            // El default del paquete usa minúscula ('js/pages'), que en
            // Windows/Docker Desktop (bind-mount insensible a mayúsculas)
            // funciona por accidente pero falla en runners Linux reales
            // (CI) — así se detectó este bug.
