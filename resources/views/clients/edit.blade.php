                ...
                <form method="POST" action="{{ route('clients.update', $client) }}" class="space-y-10">
                    ...
                    <div>
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-black text-ink uppercase tracking-widest">Información de Perfil</h3>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="ui-label" for="name">Nombre Completo</label>
                                <input id="name" name="name" value="{{ old('name', $client->user?->name) }}" class="ui-input !bg-panel border-ink/10 text-ink" required>
                            ...
                            <div>
                                ...
                                <input id="email" type="email" name="email" value="{{ old('email', $client->user?->email) }}" class="ui-input !bg-panel border-ink/10 text-ink" required>
                            ...
                            <div>
                                ...
                                <input id="telefono" name="telefono" value="{{ old('telefono', $client->telefono) }}" class="ui-input !bg-panel border-ink/10 text-ink">
                            ...
                            <div>
                                ...
                                <input id="fecha_nacimiento" type="date" name="fecha_nacimiento" value="{{ old('fecha_nacimiento', $client->fecha_nacimiento?->format('Y-m-d')) }}" class="ui-input !bg-panel border-ink/10 text-ink">
                    ...
                    <div class="pt-8 border-t border-ink/5">
                        ...
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-black text-ink uppercase tracking-widest">Canales de Notificación</h3>
                        </div>
