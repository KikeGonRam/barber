                ...
                <form method="POST" action="{{ route('clients.store') }}" class="space-y-10">
                    ...
                    <div>
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-black text-white uppercase tracking-widest">Información Personal</h3>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="ui-label" for="name">Nombre Completo</label>
                                <input id="name" name="name" value="{{ old('name') }}" class="ui-input !bg-panel border-white/10 text-white" required placeholder="Ej: Roberto Gómez">
                            ...
                            <div>
                                ...
                                <input id="email" type="email" name="email" value="{{ old('email') }}" class="ui-input !bg-panel border-white/10 text-white" required placeholder="cliente@email.com">
                            ...
                            <div>
                                ...
                                <input id="telefono" name="telefono" value="{{ old('telefono') }}" class="ui-input !bg-panel border-white/10 text-white" placeholder="+52 ...">
                            ...
                            <div>
                                ...
                                <input id="fecha_nacimiento" type="date" name="fecha_nacimiento" value="{{ old('fecha_nacimiento') }}" class="ui-input !bg-panel border-white/10 text-white">
                    ...
                    <div class="pt-8 border-t border-white/5">
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-black text-white uppercase tracking-widest">Acceso al Portal (Opcional)</h3>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="ui-label" for="password">Contraseña</label>
                                <input id="password" type="password" name="password" class="ui-input !bg-panel border-white/10 text-white" placeholder="••••••••">
                            ...
                            <div>
                                ...
                                <input id="password_confirmation" type="password" name="password_confirmation" class="ui-input !bg-panel border-white/10 text-white" placeholder="••••••••">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pt-8 border-t border-white/5">
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-black text-white uppercase tracking-widest">Preferencias de Contacto</h3>
                        </div>
