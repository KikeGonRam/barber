...
<div x-show="metodoPago === 'efectivo'" x-transition class="rounded-2xl border border-emerald-500/10 bg-emerald-950/10 p-5">
    <div class="flex items-start gap-4">
        ...
        <div>
            <p class="text-sm font-black text-white">Pago en efectivo</p>
...
<div x-show="metodoPago === 'tarjeta'" x-transition class="rounded-2xl border border-amber-500/15 bg-amber-950/[0.06] p-5 space-y-4">
    <div class="flex items-center justify-between">
        <p class="text-sm font-black text-white">Tarjeta débito / crédito</p>
    ...
    <div class="space-y-3 opacity-35 pointer-events-none select-none">
        <div>
            ...
            <input type="text" disabled placeholder="•••• •••• •••• ••••"
                class="mt-1 w-full rounded-xl border border-white/5 bg-white/[0.02] px-4 py-3 font-mono text-sm text-white placeholder-muted/30">
        </div>
        <div>
            ...
            <input type="text" disabled placeholder="Nombre como aparece en la tarjeta"
                class="mt-1 w-full rounded-xl border border-white/5 bg-white/[0.02] px-4 py-3 text-sm text-white placeholder-muted/30">
        </div>
