<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a href="{{ route('inventory.movements.index') }}" class="text-[10px] font-black uppercase tracking-widest text-muted hover:text-ink transition">
                ...
                <form method="POST" action="{{ route('inventory.movements.store') }}" class="space-y-10">
                    ...
                    <div>
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-black text-ink uppercase tracking-widest">Identificación del Movimiento</h3>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="ui-label">Producto / Suministro</label>
                                <select name="product_id" class="ui-input !bg-panel border-ink/10 text-ink" required>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    @if($canEntry)
                                        <label class="relative flex cursor-pointer items-center justify-center rounded-xl border border-ink/5 bg-ink/5 p-3 transition-all hover:border-green-500/30 has-[:checked]:border-green-500 has-[:checked]:bg-green-500/10 group">
                                    ...
                                    @endif
                                    <label class="relative flex cursor-pointer items-center justify-center rounded-xl border border-ink/5 bg-ink/5 p-3 transition-all hover:border-red-500/30 has-[:checked]:border-red-500 has-[:checked]:bg-red-500/10 group">
                    ...
                    <div class="pt-8 border-t border-ink/5">
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-black text-ink uppercase tracking-widest">Volumen & Referencia</h3>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="appointment_id" class="ui-input !bg-panel border-ink/10 text-ink">
                    ...
                    <div class="pt-8 border-t border-ink/5">
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-black text-ink uppercase tracking-widest">Justificación del Cambio</h3>
                        </div>
