            ...
            <section class="ui-surface">
                <form method="POST" action="{{ route('inventory.products.update', $product) }}" enctype="multipart/form-data" class="space-y-10">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input name="nombre" value="{{ old('nombre', $product->nombre) }}" class="ui-input !bg-panel border-white/10 text-white" required>
                            ...
                            <div>
                                ...
                                <input name="categoria" value="{{ old('categoria', $product->categoria) }}" class="ui-input !bg-panel border-white/10 text-white" required>
                            ...
                            <div>
                                ...
                                <label class="mt-1 flex cursor-pointer items-center justify-between rounded-2xl border border-white/10 bg-panel px-4 py-3 text-sm font-bold text-white">
                                    ...
                                    <input id="activo" type="checkbox" name="activo" value="1" class="h-4 w-4 rounded border-white/20 bg-black text-gold focus:ring-gold" @checked((bool) old('activo', $product->isActive()))>
                                </label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" step="0.01" min="0" name="precio_compra" value="{{ old('precio_compra', $product->precio_compra) }}" class="ui-input !pl-10 !bg-panel border-white/10 text-white" required>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" step="0.01" min="0" name="precio_venta" value="{{ old('precio_venta', $product->precio_venta) }}" class="ui-input !pl-10 !bg-panel border-white/10 text-white" required>
                                </div>
                            </div>
                            <div>
                                <label class="ui-label">Stock Actual</label>
                                <input type="number" min="0" name="stock_actual" value="{{ old('stock_actual', $product->stock_actual) }}" class="ui-input !bg-panel border-white/10 text-white" required>
                            </div>
                            <div>
                                <label class="ui-label">Mínimo Crítico</label>
                                <input type="number" min="0" name="stock_minimo" value="{{ old('stock_minimo', $product->stock_minimo) }}" class="ui-input !bg-panel border-white/10 text-white" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pt-8 border-t border-white/5">
                        ...
                        <div>
                            <textarea name="descripcion" rows="4" class="ui-input !bg-panel border-white/10 text-white leading-relaxed">{{ old('descripcion', $product->descripcion) }}</textarea>
