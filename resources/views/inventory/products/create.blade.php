            ...
            <section class="ui-surface">
                <form method="POST" action="{{ route('inventory.products.store') }}" enctype="multipart/form-data" class="space-y-10">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input name="nombre" value="{{ old('nombre') }}" class="ui-input !bg-panel border-ink/10 text-ink" required placeholder="Ej: Cera Mate Premium">
                            ...
                            <div>
                                ...
                                <input name="categoria" value="{{ old('categoria') }}" class="ui-input !bg-panel border-ink/10 text-ink" required placeholder="Ej: Estilizado">
                            ...
                            <div>
                                ...
                                <label class="mt-1 flex cursor-pointer items-center justify-between rounded-2xl border border-ink/10 bg-panel px-4 py-3 text-sm font-bold text-ink">
                                    ...
                                    <input id="activo" type="checkbox" name="activo" value="1" class="h-4 w-4 rounded border-ink/20 bg-black text-gold focus:ring-gold" @checked(old('activo', '1') === '1')>
                                </label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" step="0.01" min="0" name="precio_compra" value="{{ old('precio_compra') }}" class="ui-input !pl-10 !bg-panel border-ink/10 text-ink" required>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" step="0.01" min="0" name="precio_venta" value="{{ old('precio_venta') }}" class="ui-input !pl-10 !bg-panel border-ink/10 text-ink" required>
                                </div>
                            </div>
                            <div>
                                <label class="ui-label">Stock Inicial</label>
                                <input type="number" min="0" name="stock_actual" value="{{ old('stock_actual', 0) }}" class="ui-input !bg-panel border-ink/10 text-ink" required>
                            </div>
                            <div>
                                <label class="ui-label">Mínimo Crítico</label>
                                <input type="number" min="0" name="stock_minimo" value="{{ old('stock_minimo', 0) }}" class="ui-input !bg-panel border-ink/10 text-ink" required title="Alertar cuando el stock baje de este valor">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pt-8 border-t border-ink/5">
                        ...
                        <div>
                            <textarea name="descripcion" rows="4" class="ui-input !bg-panel border-ink/10 text-ink leading-relaxed" placeholder="Especificaciones, marca o modo de uso...">{{ old('descripcion') }}</textarea>
