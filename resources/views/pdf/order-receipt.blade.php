...
<meta charset="utf-8">
<style>
    /* Recibo de pedido imprimible: fondo claro. */
    * { font-family: DejaVu Sans, sans-serif; }
    ...
    .grand td { border-top: 2px solid #111; padding-top: 12px; border-bottom: none; }
    .grand .tk { font-size: 13px; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; color: #111; }
    .grand .tv { text-align: right; font-size: 20px; font-weight: bold; color: #b8942e; }
...
<div class="sheet">
    ...
    <table class="items">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="r">${{ number_format($it['subtotal'] ?? ($it['precio'] * $it['cantidad']), 2) }}</td>
            </tr>
            @endforeach
            <tr class="grand">
                <td class="tk" colspan="2">Total</td>
    ...
    <table style="width:100%; margin-top:22px;">
        <tr>
            <td><span class="paid">Entregado</span></td>
    ...
    <div class="foot">Gracias por tu compra. Este recibo fue generado electronicamente por UrbanBlade.</div>
