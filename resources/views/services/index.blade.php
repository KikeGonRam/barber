                                ...
                                <td class="text-right">
                                    <div class="flex justify-end gap-2 opacity-60 group-hover:opacity-100 transition-opacity">
                                        ...
                                        <form action="{{ route('services.destroy', $service) }}" method="POST"
                                            ...
                                            @csrf @method('DELETE')
                                            <button type="submit" aria-label="Eliminar servicio" class="h-8 w-8 rounded-lg border border-red-500/20 bg-red-500/5 flex items-center justify-center text-red-500/70 hover:text-red-400 hover:bg-red-500/10 transition-all">
