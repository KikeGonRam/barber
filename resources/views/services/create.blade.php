<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="ui-title">Nuevo <span class="text-gold">Servicio Signature</span></h2>
                <p class="ui-subtitle">Define una nueva experiencia de lujo para tus clientes.</p>
            </div>
            <a href="{{ route('services.index') }}" class="text-[10px] font-black uppercase tracking-widest text-muted hover:text-white transition">
                ...
                <form method="POST" action="{{ route('services.store') }}" enctype="multipart/form-data" class="space-y-10">
                    ...
                    <div>
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-black text-white uppercase tracking-widest">Definición del Servicio</h3>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input id="nombre" name="nombre" value="{{ old('nombre') }}" 
                                       ...
                                       placeholder="Ej: Afeitado Imperial" required>
                            ...
                            <div>
                                ...
                                <input id="categoria" name="categoria" value="{{ old('categoria') }}" 
                                       class="ui-input !bg-panel border-white/10 text-white" 
                                       placeholder="Ej: Afeitado Clásico" required>
                    ...
                    <div class="pt-8 border-t border-white/5">
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-black text-white uppercase tracking-widest">Valor & Tiempo</h3>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input id="duracion_min" type="number" min="5" name="duracion_min" value="{{ old('duracion_min') }}" 
                    ...
                    <div class="pt-8 border-t border-white/5">
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-black text-white uppercase tracking-widest">Detalles Adicionales</h3>
                        </div>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <textarea id="descripcion" name="descripcion" rows="4" 
                                          ...
                                          placeholder="Describe los beneficios y pasos del servicio...">{{ old('descripcion') }}</textarea>
                    ...
                    <div class="pt-8 border-t border-white/5">
                        ...
                        <div>
                            <label class="ui-label" for="imagen">Foto del Servicio <span class="text-muted">(opcional, máx. 2 MB)</span></label>
                    ...
                    <div class="pt-10 border-t border-white/5 flex justify-end">
                        <button type="submit" class="ui-btn px-16 py-4 text-[11px] uppercase tracking-[0.2em] shadow-lg shadow-gold/20">
                            Publicar Servicio Signature <span class="ml-2 opacity-50">&rarr;</span>
                        </button>
                    </div>
                </form>
            </section>
