...
<head>
    ...
    {{-- Identidad seleccionable por usuario: data-theme en <html> arriba (renderizado en servidor,
         sin flash). Los 4 temas viven en resources/css/app.css. Se cambia desde /profile. --}}
