                ...
                <form method="POST" action="{{ route('settings.update') }}" class="space-y-10">
                    ...
                    <div>
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-black text-ink uppercase tracking-widest">Identidad & Contacto</h3>
                        </div>
                        
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div>
                                <label class="ui-label" for="nombre">Nombre Comercial</label>
                                <input id="nombre" name="nombre" value="{{ old('nombre', $setting->nombre) }}" class="ui-input !bg-panel border-ink/10 text-ink" required>
                            ...
                            <div>
                                ...
                                <input id="telefono" name="telefono" value="{{ old('telefono', $setting->telefono) }}" class="ui-input !bg-panel border-ink/10 text-ink">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input id="direccion" name="direccion" value="{{ old('direccion', $setting->direccion) }}" class="ui-input !bg-panel border-ink/10 text-ink">
                    ...
                    <div class="pt-8 border-t border-ink/5">
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-black text-ink uppercase tracking-widest">Horarios & Políticas</h3>
                        </div>

                        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                            <div>
                                <label class="ui-label" for="horario_apertura">Apertura</label>
                                <input id="horario_apertura" type="time" name="horario_apertura" value="{{ old('horario_apertura', $setting->horario_apertura) }}" class="ui-input !bg-panel border-ink/10 text-ink">
                            ...
                            <div>
                                ...
                                <input id="horario_cierre" type="time" name="horario_cierre" value="{{ old('horario_cierre', $setting->horario_cierre) }}" class="ui-input !bg-panel border-ink/10 text-ink">
                            ...
                            <div>
                                ...
                                <input id="politica_cancelacion" type="number" min="1" max="168" name="politica_cancelacion" value="{{ old('politica_cancelacion', $setting->politica_cancelacion) }}" class="ui-input !bg-panel border-ink/10 text-ink" required>
                    ...
                    <div class="pt-8 border-t border-ink/5">
                        ...
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-black text-ink uppercase tracking-widest">Presencia Digital</h3>
                        </div>

                        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                            <div>
                                <label class="ui-label" for="instagram">Instagram</label>
                                <input id="instagram" name="instagram" value="{{ old('instagram', $social['instagram'] ?? '') }}" class="ui-input !bg-panel border-ink/10 text-ink" placeholder="@usuario">
                            </div>
                            <div>
                                <label class="ui-label" for="facebook">Facebook</label>
                                <input id="facebook" name="facebook" value="{{ old('facebook', $social['facebook'] ?? '') }}" class="ui-input !bg-panel border-ink/10 text-ink" placeholder="url de página">
                            </div>
                            <div>
                                <label class="ui-label" for="tiktok">Tiktok</label>
                                <input id="tiktok" name="tiktok" value="{{ old('tiktok', $social['tiktok'] ?? '') }}" class="ui-input !bg-panel border-ink/10 text-ink" placeholder="@usuario">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pt-8 border-t border-ink/5">
                        ...
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-sm font-black text-ink uppercase tracking-widest">Datos Bancarios (Transferencia)</h3>
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div class="md:col-span-2">
                                ...
                                <input id="clabe" name="clabe" maxlength="18"
                                       ...
                                       class="ui-input !bg-panel border-ink/10 text-ink font-mono"
                            ...
                            <div>
                                ...
                                <input id="banco" name="banco"
                                       ...
                                       class="ui-input !bg-panel border-ink/10 text-ink"
                    ...
                    <div class="pt-10 border-t border-ink/5 flex items-center justify-between gap-4">
                        <a href="{{ route('dashboard') }}" class="px-8 py-4 rounded-xl border border-ink/10 text-[11px] font-black uppercase tracking-[0.2em] text-muted hover:text-ink hover:border-ink/20 transition-all">
                            Cancelar
                        </a>
