                    ...
                    <div class="pt-8 border-t border-white/5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input id="fecha" type="date" name="fecha" value="{{ old('fecha', optional($appointment->fecha)->format('Y-m-d')) }}" class="ui-input !bg-panel border-white/10 text-white" required>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            <div>
                                ...
                                <input id="hora_inicio" type="time" name="hora_inicio" value="{{ old('hora_inicio', \Illuminate\Support\Str::of($appointment->hora_inicio)->substr(0, 5)) }}" class="ui-input !bg-panel border-white/10 text-white" required>
                            ...
                            <div>
                                ...
                                <input id="hora_fin" type="time" name="hora_fin" value="{{ old('hora_fin', \Illuminate\Support\Str::of($appointment->hora_fin)->substr(0, 5)) }}" class="ui-input !bg-panel border-white/10 text-white" required>
