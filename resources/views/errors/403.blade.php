...
<head>
    ...
    <title>403 - Acceso Restringido | UrbanBlade</title>
...
<body class="font-sans antialiased text-ink bg-card">
    <div class="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 px-4 text-center">
            <h1 class="select-none text-[clamp(6rem,24vw,12rem)] font-black leading-none text-ink/5">403</h1>
            <div class="-mt-12 rounded-[1.5rem] border border-ink/[0.08] bg-ink/[0.025] p-6 backdrop-blur-xl sm:-mt-20 sm:p-8">
                ...
                <h2 class="mb-4 text-3xl font-black uppercase tracking-tighter text-ink sm:text-4xl">Solo para <span class="text-gold">usuarios autorizados</span></h2>
