...
<body class="font-sans antialiased text-white bg-[#0a0a0a]">
    <div class="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 px-4 text-center">
            <h1 class="select-none text-[clamp(6rem,24vw,12rem)] font-black leading-none text-white/5">404</h1>
            <div class="-mt-12 rounded-[1.5rem] border border-white/[0.08] bg-white/[0.025] p-6 backdrop-blur-xl sm:-mt-20 sm:p-8">
                ...
                <h2 class="mb-4 text-3xl font-black uppercase tracking-tighter text-white sm:text-4xl">Página <span class="text-gold">no encontrada</span></h2>
